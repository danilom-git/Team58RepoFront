  ...
  render() {
    return (
        <div className="container-fluid pt-2">
            <div className="row">
                <Sidebar
                links={[{id: 1, text: 'User profile'},{id: 2, text: 'Patients',onClick:this.showPatients},{id: 3, text: 'Working calendar'},{id: 4, text: 'Absence request',onClick:this.showAbsence},{id: 5, text: 'Annual leave request'}]}
                />
                {this.state.main}
            </div>
        </div>
